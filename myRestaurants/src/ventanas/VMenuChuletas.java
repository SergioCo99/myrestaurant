...
public class VMenuChuletas extends JFrame{
	...
	public VMenuChuletas() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.setLayout(new GridLayout(1,1));
		setBounds(100, 100, 450, 300);
		Chuleta v = new Chuleta();
	...
	public void tabla() {
		...
		String[]p2= {"Paco", "10", "22", "900 000 001", "Chuletas"};
		String[]p3= {"Fernando", "14", "23",  "900 000 004", "Chuletas"};
		String[]p4= {"Casa Jose", "12", "22", "900 000 005", "Chuletas"};
		...
		tabla.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent mouseEvent) {
		        ...
		        if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
		        	...
		        	JOptionPane.showMessageDialog(rootPane, "Restaurante Paco\n"
		        			+ "Abrimos todos los días\n"
		        			+ "Especialidad en chuletas y comida a la brasa\n"
		        			+ "Menú del día 10€\n"
		        			+ "Menú especial 25€\n"
		        			+ "Menu Chuleta 30€");
		        	if(table.isRowSelected(1))
			        JOptionPane.showMessageDialog(rootPane,  "Restaurante Fernando\n"
		        			+ "De Martes a Domingo\n"
		        			+ "Si quieres comer bien, ven donde Fernando\n"
		        			+ "Menú del día 9.50€\n"
		        			+ "Menú especial 15€\n"
		        			+ "Menu Chuleta 24.90€");
		        	if(table.isRowSelected(2))
				    JOptionPane.showMessageDialog(rootPane, "Casa Jose\n"
