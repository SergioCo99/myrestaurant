...
public class VMenuCasera extends JFrame{
	...
	public void tabla() {
		...
		String[]p2= {"Antonia", "10", "22", "900 000 020", "Comida Casera"};
		String[]p3= {"Paquita", "14", "23",  "900 000 021", "Comida Casera"};
		String[]p4= {"Josefa", "12", "22", "900 000 022", "Comida Casera"};
		...
		tabla.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent mouseEvent) {
		        ...
		        if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
		        	...
		        	JOptionPane.showMessageDialog(rootPane, "Restaurante Antonia\n"
		        			+ "Abrimos todos los días\n"
		        			+ "Especialidad en comida con cariño\n"
		        			+ "Menú del día 10€\n"
		        			+ "Menú especial 25€\n"
		        			+ "Menu Antonia 30€");
		        	if(table.isRowSelected(1))
			        JOptionPane.showMessageDialog(rootPane,  "Restaurante Paquita\n"
		        			+ "De Martes a Domingo\n"
		        			+ "Si quieres comer bien, ven donde Paquita\n"
		        			+ "Menú del día 9.50€\n"
		        			+ "Menú especial 15€\n"
		        			+ "Menu Paquita 24.90€");
		        	if(table.isRowSelected(2))
				    JOptionPane.showMessageDialog(rootPane, "Restaurante Josefa\n"
