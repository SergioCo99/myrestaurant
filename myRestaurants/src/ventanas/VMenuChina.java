...
public class VMenuChina extends JFrame{
	...
	public void tabla() {
		...
		String[]p2= {"Li", "10", "22", "900 000 011", "China"};
		String[]p3= {"Mao", "14", "23",  "900 000 012", "China"};
		String[]p4= {"Yu", "12", "22", "900 000 013", "China"};
		...
		tabla.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent mouseEvent) {
		        ...
		        if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
		        	...
		        	JOptionPane.showMessageDialog(rootPane, "Restaurante Li\n"
		        			+ "Abrimos todos los días\n"
		        			+ "Especialidad en galletas de la suerte\n"
		        			+ "Menú del día 10€\n"
		        			+ "Menú especial 25€\n"
		        			+ "Menu Pekín 30€");
		        	if(table.isRowSelected(1))
			        JOptionPane.showMessageDialog(rootPane,  "Restaurante Mao\n"
		        			+ "De Martes a Domingo\n"
		        			+ "Si quieres comer bien, ven donde Mao\n"
		        			+ "Menú del día 9.50€\n"
		        			+ "Menú especial 15€\n"
		        			+ "Menu Mao 24.90€");
		        	if(table.isRowSelected(2))
				    JOptionPane.showMessageDialog(rootPane, "Restaurante Yu\n"
		        			+ "Abierto todos los días\n"
		        			+ "Sabor y tradición China\n"
		        			+ "Menú del día 9.50€\n"
		        			+ "Menú especial 15€\n"
		        			+ "Menu Yu 24.90€");
