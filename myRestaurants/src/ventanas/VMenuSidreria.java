...
public class VMenuSidreria extends JFrame{
	...
	public VMenuSidreria() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.setLayout(new GridLayout(1,1));
		setBounds(100, 100, 450, 300);
		Sidreria v = new Sidreria();
	...
	public void tabla() {
		...
		String[]p2= {"Patxi", "10", "22", "900 000 040", "Sidrería"};
		String[]p3= {"Andoni", "14", "23",  "900 000 041", "Sidrería"};
		String[]p4= {"Mikel", "12", "22", "900 000 042", "Sidrería"};
		...
		tabla.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent mouseEvent) {
		        ...
		        if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
		        	...
		        	JOptionPane.showMessageDialog(rootPane, "Sidrería Patxi\n"
			        ...
			        JOptionPane.showMessageDialog(rootPane,  "Sidrería Andoni\n"
		        			+ "De Martes a Domingo\n"
		        			+ "Si quieres comer bien, ven donde Andoni\n"
		        			+ "Menú del día 9.50€\n"
		        			+ "Menú especial 15€\n"
		        			+ "Menu Chuleta 24.90€");
		        	if(table.isRowSelected(2))
				    JOptionPane.showMessageDialog(rootPane, "Sidrería Mikel\n"
